> **Note:** This is the backend module of a monorepo. For full setup and run instructions (backend + frontend + AI underwriter), see the top-level [`../README.md`](../README.md). Some paths below (e.g. `cd loanworkflow`) are stale — the project now lives under `backend/`.
...
src/main/java/com/work/loanworkflow/
├── config/
│   ├── DBConfig.java
│   └── DBConnection.java
├── controller/
